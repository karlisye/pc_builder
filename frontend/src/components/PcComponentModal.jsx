    ...
    <div className="fixed top-0 bottom-0 left-0 right-0 backdrop-blur-xs" onClick={handleLeave}>
      ...
      >
        <div className="flex justify-between">
          <h2 className="font-bold text-3xl mb-6 bg-primary-light px-6 py-1 rounded-md text-secondary">Component info</h2>
        ...
        <div>
          {Object.entries(component).map(([key, value]) => {
            if (!value || key === 'id' || key === 'category' || key === 'scraped_at' || key === 'url') return null;
