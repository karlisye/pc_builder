...
return [
    ...
    'motherboard_no_case_support' => 'No cases in stock fit a :mb_form motherboard — this build cannot be completed with this motherboard',
    'case_no_motherboard_support' => 'No motherboards in stock fit a :case_form case — this build cannot be completed with this case',
];
