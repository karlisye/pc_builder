...
Python scraper that coll ects PC com ponent data from [https://www.dateks.lv/en](https://www.dateks.lv/en) and stores it in MySQL. Powers a Laravel 12 + Inertia + React PC builder app.
